...
.mytooltip-content {
	...
	<script>
		...
		$("#ch_new_pw").off("keyup").on("keyup", function() { $("#ch_new_pw").blur(); $("#ch_new_pw").focus(); }); //비밀번호 안정성 
